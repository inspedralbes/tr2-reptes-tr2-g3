<template>
 ...
 <h3 class="text-h6 font-weight-bold mb-1">{{ taller.nom }}</h3>
					 <div class="text-caption text-grey mb-3">
						 ...
						 <span class="font-weight-medium">{{ taller.dia_preferit || 'Dia pendent' }}</span>
					 </div>
 ...
 Descarregar Plantilla
					...
					<p class="text-subtitle-2 mb-2">Pujar llistat per a: <strong>{{ tallerSeleccionado?.nom }}</strong>
						<span class="text-caption text-grey ml-3">· {{ tallerSeleccionado?.dia_preferit || 'Dia pendent' }}</span>
					</p>
